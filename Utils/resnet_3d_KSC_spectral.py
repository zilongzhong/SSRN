...
def basic_block(nb_filters, init_subsample=(1, 1, 1)):
    def f(input):
        conv1 = _bn_relu_conv(nb_filters, 1, 1, 9, subsample=init_subsample)(input)
        print("conv shape:", conv1._keras_shape)
        residual = _bn_relu_conv(nb_filters, 1, 1, 9)(conv1)
        print("res shape:", residual._keras_shape)
...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions):
        ...
        conv1 = _conv_bn_relu(nb_filter=1, conv_dim1=7, conv_dim2=7, conv_dim3=1)(input)
