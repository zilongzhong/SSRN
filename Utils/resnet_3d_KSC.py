...
def _conv_bn_relu(**conv_params):
    ...
    def f(input):
        conv = Convolution3D(nb_filter=nb_filter, kernel_dim1=kernel_dim1, kernel_dim2=kernel_dim2,kernel_dim3=kernel_dim3, subsample=subsample,
                             border_mode=border_mode, init=init, W_regularizer=W_regularizer)(input)
...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions):
        ...
        conv1 = _conv_bn_relu(nb_filter=32, kernel_dim1=3, kernel_dim2=3, kernel_dim3=176, subsample=(2, 2, 1))(input)
    ...
    def build_resnet_6(input_shape, num_outputs):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [1, 1, 1])      #[2, 2, 2, 2]
...
def main():
    model = ResnetBuilder.build_resnet_6((1, 7, 7, 176), 13)          #model = ResnetBuilder.build_resnet_18((3, 224, 224), 1000)
