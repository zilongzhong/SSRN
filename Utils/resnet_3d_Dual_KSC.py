...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions):
        ...
        conv1 = _conv_bn_relu(nb_filter=32, conv_dim1=4, conv_dim2=4, conv_dim3=176)(input)
...
def main():
    model = ResnetBuilder.build_resnet_10((1, 7, 7, 176), 13)          #model = ResnetBuilder.build_resnet_18((3, 224, 224), 1000)
