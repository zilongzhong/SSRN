...
def basic_block(nb_filters, init_subsample=(1, 1, 1)):
    def f(input):
        ...
        conv2 = _bn_relu_conv(nb_filters, 2, 2, 1, subsample=init_subsample)(input)
        residual2 = _bn_relu_conv(nb_filters, 2, 2, 1)(conv2)

        return _shortcut(input, residual, residual2)
...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions):
        ...
        conv1 = _conv_bn_relu(nb_filter=32, conv_dim1=4, conv_dim2=4, conv_dim3=103)(input)
        #conv1 = Convolution3D(nb_filter=32, kernel_dim1=4, kernel_dim2=4, kernel_dim3=200)(input)
...
def main():
    model = ResnetBuilder.build_resnet_10((1, 7, 7, 103), 16)          #model = ResnetBuilder.build_resnet_18((3, 224, 224), 1000)
