...
**UPDATE:** A PyTorch implementation of SSTN is available at [SSTN](https://github.com/zilongzhong/SSTN). Specifically, you can find it here: [PyTorch-SSRN](https://github.com/zilongzhong/SSTN/blob/main/NetworksBlocks.py)
