...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions):
        ...
        zeropad_input = ZeroPadding2D(padding=(2, 2), dim_ordering='tf')(input)
        print("zeropad1_input shape:", zeropad_input._keras_shape)
        conv1 = _conv_bn_relu(nb_filter=64, nb_row=7, nb_col=7, subsample=(2, 2))(zeropad_input)
...
#        print("pool1 shape:", pool1._keras_shape)
    ...
    def build_resnet_20(input_shape, num_outputs):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 2, 3, 2])

    @staticmethod
    def build_resnet_50(input_shape, num_outputs):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [5, 6, 8, 5])
...
def main():
    model = ResnetBuilder.build_resnet_50((103, 27, 27), 9)          #model = ResnetBuilder.build_resnet_18((3, 224, 224), 1000)
