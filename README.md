...
**![#f03c15]UPDATE:`#f03c15`** A PyTorch implementation of SSTN is available in this github repo [SSTN](https://github.com/zilongzhong/SSTN). Specifically, you can find it in this link: [PyTorch-SSRN](https://github.com/zilongzhong/SSTN/blob/main/NetworksBlocks.py)
