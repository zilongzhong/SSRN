...
**UPDATE:** A PyTorch implementation of SSRN is available at [SSTN](https://github.com/zilongzhong/SSTN). Specifically, you can find it here: [PyTorch-SSRN](https://github.com/zilongzhong/SSTN/blob/ddb68a2bac229793bfc0e67dcf9caf1527a3cea2/NetworksBlocks.py#L271)
